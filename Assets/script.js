$(document).ready(function (){
    ...
    $(".myClass").on('click', function (event){
        ...
        if (city != ''){
            $.ajax({
                url: `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=imperial&APPID=e61f3d1e1de6bb344c24c726485dc3da`,
                type: "GET",
                datatype: "jsonp",
    ...
    function uvIndexFunction(lat, lon) {
        ...
        var queryURLData = `https://api.openweathermap.org/data/3.0/onecall?lat=${lat}&lon=${lon}&exlclude={part}&APPID=e61f3d1e1de6bb344c24c726485dc3da`
        $.ajax({
            url: queryURLData,
            method: "GET"
        }).then(function (data) {
